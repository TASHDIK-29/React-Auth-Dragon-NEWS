...
const HomeNewsCard = ({ item }) => {
    console.log(item);

    const { details, thumbnail_url, author, title, total_view, rating, _id ,published_date} = item;
    ...
    return (
        ...
        <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
            ...
            <div>
                ...
                <p className="text-sm dark:text-gray-600">{details.length>200 ? details.slice(0,200) : details} <Link to = {`/article/${_id}`} className="text-orange-500 text-bs font-bold">Read more....</Link> </p>
            </div>
